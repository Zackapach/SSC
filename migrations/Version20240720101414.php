 ...
 */
final class Version20240720101414 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cour (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, zone_id INT NOT NULL, notifcation_id INT NOT NULL, title VARCHAR(20) NOT NULL, description LONGTEXT NOT NULL, calendrier DATE NOT NULL, heure TIME NOT NULL, duration INT NOT NULL, disponible TINYINT(1) NOT NULL, nombre_place_disponible INT NOT NULL, INDEX IDX_A71F964FA76ED395 (user_id), INDEX IDX_A71F964F9F2C3FAB (zone_id), INDEX IDX_A71F964F78BA0164 (notifcation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE infos (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, clé VARCHAR(255) NOT NULL, valeur VARCHAR(255) NOT NULL, INDEX IDX_EECA826DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
