 ...
 */
final class Version20241113093718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cour (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, zone_id INT NOT NULL, notifcation_id INT DEFAULT NULL, title VARCHAR(20) NOT NULL, description LONGTEXT NOT NULL, disponible TINYINT(1) NOT NULL, nombre_place_disponible INT NOT NULL, calendrier DATETIME NOT NULL, duration DATETIME NOT NULL, INDEX IDX_A71F964FA76ED395 (user_id), INDEX IDX_A71F964F9F2C3FAB (zone_id), INDEX IDX_A71F964F78BA0164 (notifcation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE forfait (id INT AUTO_INCREMENT NOT NULL, user_profil_id INT NOT NULL, description LONGTEXT NOT NULL, price NUMERIC(10, 2) NOT NULL, duration_days INT NOT NULL, type_forfait VARCHAR(10) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, name LONGTEXT NOT NULL COMMENT \'(DC2Type:simple_array)\', UNIQUE INDEX UNIQ_BBB5C48227BE5D9C (user_profil_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, cour_id INT NOT NULL, status VARCHAR(50) NOT NULL, reservation_date DATE NOT NULL, reservation_time TIME NOT NULL, INDEX IDX_42C84955A76ED395 (user_id), INDEX IDX_42C84955B7942F03 (cour_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
